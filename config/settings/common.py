...
ROOT_DIR = environ.Path(__file__) - 3  # (django_example/config/settings/common.py - 3 = django_example/)
...
LOCAL_APPS = (
    # custom users app
    'django_example.users.apps.UsersConfig',
...
DATABASES = {
    ...
    'default': env.db('DATABASE_URL', default='sqlite:////tmp/django_example'),
}
